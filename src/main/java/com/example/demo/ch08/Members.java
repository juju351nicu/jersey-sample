 ...
 * <br>
 * 表8.2---------入力値の組み合わせと期待値の関係------------------------------------------------------------------<br/>
 * 年齢----------------------メルマガ登録-----------------------前月の利用回数---------------------期待値-----------<br/>
 * 20歳以上------------------YES------------------------------1回以上---------------------------true------------<br/>
 * 20歳以上------------------NO-------------------------------1回以上---------------------------false-----------<br/>
 * 20歳以上------------------YES------------------------------0回------------------------------false------------<br/>
 * 20歳以上------------------NO-------------------------------0回------------------------------false------------<br/>
 * 20歳未満------------------YES------------------------------1回以上---------------------------false------------<br/>
 * 20歳未満------------------NO-------------------------------1回以上---------------------------false------------<br/>
 * 20歳未満------------------YES------------------------------0回------------------------------false------------<br/>
 * 20歳未満------------------NO-------------------------------0回------------------------------false------------<br/>
 * <br>
 * 表8.3---------単項目に着目した入力値の組み合わせと期待値の関係-----------------------------------------------------<br/>
 * 年齢----------------------メルマガ登録-----------------------前月の利用回数---------------------期待値-----------<br/>
 * 20歳以上------------------YES------------------------------1回以上---------------------------true------------<br/>
 * 20歳未満------------------YES------------------------------1回以上---------------------------false-----------<br/>
 * 20歳以上------------------NO-------------------------------1回以上---------------------------false-----------<br/>
